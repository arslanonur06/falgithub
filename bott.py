...
async def astrology_menu(update: Update, context: CallbackContext):
    ...
    keyboard = [
        ...
        [
            ...
            InlineKeyboardButton("🌙 Gelişmiş Ay Takvimi" if lang == 'tr' else "🌙 Advanced Moon Calendar", 
    ...
    if premium_plan in ['premium', 'vip']:
        keyboard.append([
            InlineKeyboardButton("📊 Haftalık Rapor" if lang == 'tr' else "📊 Weekly Report", 
                               callback_data="weekly_astro_report"),
            InlineKeyboardButton("🌟 Gezegen Geçişleri" if lang == 'tr' else "🌟 Planetary Transits", 
    ...
    if premium_plan == 'vip':
        keyboard.append([
            InlineKeyboardButton("🤖 7/24 Astroloji Chatbot" if lang == 'tr' else "🤖 24/7 Astrology Chatbot", 
                               callback_data="astro_chatbot"),
            InlineKeyboardButton("👥 Sosyal Özellikler" if lang == 'tr' else "👥 Social Features", 
    ...
    if lang == 'tr':
        astro_message = f"""⭐ **ASTROLOJI MERKEZİ** ⭐
━━━━━━━━━━━━━━━━━━━━━━

🌟 **Doğum Haritası** - Kişisel astrolojik analiziniz
📅 **Günlük Burç** - Burcunuzun günlük rehberliği  
💕 **Uyumluluk** - İki burç arasındaki enerji analizi
🌙 **Gelişmiş Ay Takvimi** - Gerçek ay fazları ve etkileri

{'📊 **Premium Özellikler Aktif!**' if premium_plan in ['premium', 'vip'] else ''}
{'🤖 **VIP Özellikler Aktif!**' if premium_plan == 'vip' else ''}

━━━━━━━━━━━━━━━━━━━━━━
✨ *Yıldızların size söylediklerini keşfedin* ✨"""
    else:
        astro_message = f"""⭐ **ASTROLOGY CENTER** ⭐
━━━━━━━━━━━━━━━━━━━━━━

🌟 **Birth Chart** - Your personal astrological analysis
...
━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    # Diğer seçenekler
    keyboard.extend([
        [InlineKeyboardButton(get_text(lang, "plan_comparison"), 
...
async def handle_chatbot_question(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text("🤖 Analizinizi yapıyorum..." if lang == 'tr' else "🤖 Analyzing your question...")
...
💬 *Başka bir soru sorabilirsiniz...*"""
        ...
        await update.message.reply_text(
            "❌ Üzgünüm, şu anda yanıt veremiyorum. Lütfen tekrar deneyin." if lang == 'tr' else 
...
async def chatbot_close(update: Update, context: CallbackContext):
    ...
    await query.edit_message_text(
        "🤖 Chatbot kapatıldı. İyi günler!" if lang == 'tr' else "🤖 Chatbot closed. Have a great day!",
        reply_markup=get_main_menu_keyboard(query.from_user.id)
    )
